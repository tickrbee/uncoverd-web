...
type MegaStrings = {
  ...
  // High Yield
  highYieldsTitle: string; yieldsOver4: string; allReits: string; mortgageReits: string;
  diversifiedReits: string; residentialReits: string; retailReits: string; officeReits: string;
  industrialReits: string; healthcareReits: string;
  // Calendar
          ...
          <NavItem label={t.highYield} menuKey="high-yield" open={open} onOpen={openMenu} onClose={scheduleClose}>
            <MenuGrid columns={2}>
              ...
              <MenuCol title="REITs">
                ...
                <MenuLink href="/industries/reit?reit=diversified">{m.diversifiedReits}</MenuLink>
                <MenuLink href="/industries/reit?reit=residential">{m.residentialReits}</MenuLink>
                <MenuLink href="/industries/reit?reit=retail">{m.retailReits}</MenuLink>
                <MenuLink href="/industries/reit?reit=office">{m.officeReits}</MenuLink>
          ...
          <NavItem label={t.tools} menuKey="tools" open={open} onOpen={openMenu} onClose={scheduleClose}>
            <MenuGrid columns={2}>
              <MenuCol title={m.toolsTitle}>
                ...
                <MenuLink href="/tools/portfolio-generator">{m.portfolioGenerator}</MenuLink>
              </MenuCol>
          ...
          >
            ...
            <nav className="dv-mobile-nav" onClick={(e) => {
              ...
              <MobileGroup title={t.tools}>
                ...
                <Link href="/tools/portfolio-generator">{m.portfolioGenerator}</Link>
